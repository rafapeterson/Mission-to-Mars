...
#this function will initialize the browser, create a data dictionary, & end the WebDriver & return scraped data.
def scrape_all():
    # Initiate headless driver for deployment
    executable_path = {'executable_path': ChromeDriverManager().install()}
    browser = Browser('chrome', **executable_path, headless=True)
    news_title, news_paragraph = mars_news(browser)
    #Tells python using mars_news function to pull data
    data = {
...
def mars_facts():
    ...
    try:
        ...
        return None
    # Assign columns & set index of DF
